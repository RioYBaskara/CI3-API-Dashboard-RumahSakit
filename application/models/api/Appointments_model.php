...
class Appointments_model extends CI_Model
{
    ...
    public function show($id = 0)
    {
        $fields = "appointment.appointment_id, appointment.pasien_id, pasien.pasien_nm, 
                   ...
                   departemen.departemen_nm, appointment.appointment_date, appointment.appointment_status, appointment.is_active, appointment.created_at, appointment.created_by, appointment.updated_at, appointment.updated_by";

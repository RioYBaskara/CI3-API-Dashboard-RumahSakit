    ...
    public function index_put($id)
    {
        ...
        if (isset($headers['Authorization'])) {
            ...
            if ($decodedToken['status']) {
                ...
                $response > 0 ? $this->response($final, REST_Controller::HTTP_OK) : $this->response(['Not updated'], REST_Controller::HTTP_OK);
                // ------------- End -------------
            } else {
                $this->response($decodedToken);
            }
    ...
    public function index_delete($id)
    {
        ...
        if (isset($headers['Authorization'])) {
            ...
            if ($decodedToken['status']) {
                ...
                $response > 0 ? $this->response(['Product ' . $id . ' deleted successfully.'], REST_Controller::HTTP_OK) : $this->response(['Not deleted'], REST_Controller::HTTP_OK);
                // ------------- End -------------
            } else {
                $this->response($decodedToken);
            }

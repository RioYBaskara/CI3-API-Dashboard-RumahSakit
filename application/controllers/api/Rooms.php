...
class Rooms extends REST_Controller
{
    ...
    public function index_post()
    {
        ...
        $insert_id = $this->Rooms_model->insert($data);
    ...
    public function index_put($id)
    {
        ...
        $dataExists = $this->Rooms_model->show($id);
        if (!$dataExists) {
            $this->response([
                'status' => false,
                'message' => 'Not Found',
        ...
        $updateStatus = $this->Rooms_model->update($data, $id);
    ...
    public function index_delete($id = null)
    {
        ...
        $deleteStatus = $this->Rooms_model->delete($id, $user->username);

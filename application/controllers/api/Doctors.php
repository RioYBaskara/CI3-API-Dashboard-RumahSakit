...
class Doctors extends REST_Controller
{
    ...
    public function index_post()
    {
        ...
        // validasi
        $this->form_validation->set_rules('dokter_nm', 'dokter_nm', 'required|max_length[100]');
        $this->form_validation->set_rules('dokter_specialty', 'dokter_specialty', 'required|max_length[100]');
        $this->form_validation->set_rules('dokter_phone', 'dokter_phone', 'required|numeric|max_length[15]');
